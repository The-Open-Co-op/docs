...
Working drafts live in Google Docs — ask for access in the contributor Signal group. When a doc is stable, it gets promoted to the [docs site](https://docs.open.coop) via a pull request to the `docs` repo. Specs and architecture decisions live in the [planet repo](https://github.com/The-Open-Co-op/planet) under `specs/` and `adr/`.
