...
A cooperative has no investors to satisfy. The members are the owners - the infrastructure exists to serve them. PLANET's cooperative structure is a commitment: this infrastructure will never be sold, never be [enshittified](https://en.wikipedia.org/wiki/Enshittification), and never put investors before the people who depend on it.
